...
from pyecharts.charts import Grid, Bar, Line, Scatter, Kline
...
# grid_vertical().render(r'Grid-上下布局.html')
...
# grid_horizontal().render(r'Grid-左右布局.html')
...
# grid_mutil_yaxis().render(r'Grid-多 Y 轴示例.html')


# 4、Grid-高级应用(多图联动)
def kline_profession_example():
...
kline_profession_example().render(r'Grid-高级应用(多图联动).html')
